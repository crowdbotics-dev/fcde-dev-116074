...
export const api_v1_rohit_list = createAsyncThunk("rohits/api_v1_rohit_list", async payload => {
  const response = await apiService.api_v1_rohit_list(payload);
  return response.data;
});
export const api_v1_rohit_create = createAsyncThunk("rohits/api_v1_rohit_create", async payload => {
  const response = await apiService.api_v1_rohit_create(payload);
  return response.data;
});
export const api_v1_rohit_retrieve = createAsyncThunk("rohits/api_v1_rohit_retrieve", async payload => {
  const response = await apiService.api_v1_rohit_retrieve(payload);
  return response.data;
});
export const api_v1_rohit_update = createAsyncThunk("rohits/api_v1_rohit_update", async payload => {
  const response = await apiService.api_v1_rohit_update(payload);
  return response.data;
});
export const api_v1_rohit_partial_update = createAsyncThunk("rohits/api_v1_rohit_partial_update", async payload => {
  const response = await apiService.api_v1_rohit_partial_update(payload);
  return response.data;
});
export const api_v1_rohit_destroy = createAsyncThunk("rohits/api_v1_rohit_destroy", async payload => {
...
const rohitsSlice = createSlice({
  ...
  extraReducers: builder => {
    builder.addCase(api_v1_rohit_list.pending, (state, action) => {
