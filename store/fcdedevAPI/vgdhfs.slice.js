...
export const api_v1_vgdhf_list = createAsyncThunk(
  "vgdhfs/api_v1_vgdhf_list",
  async payload => {
    const response = await apiService.api_v1_vgdhf_list(payload)
    return response.data
  }
)
export const api_v1_vgdhf_create = createAsyncThunk(
  "vgdhfs/api_v1_vgdhf_create",
  async payload => {
    const response = await apiService.api_v1_vgdhf_create(payload)
    return response.data
  }
)
export const api_v1_vgdhf_retrieve = createAsyncThunk(
  "vgdhfs/api_v1_vgdhf_retrieve",
  async payload => {
    const response = await apiService.api_v1_vgdhf_retrieve(payload)
    return response.data
  }
)
export const api_v1_vgdhf_update = createAsyncThunk(
  "vgdhfs/api_v1_vgdhf_update",
  async payload => {
    const response = await apiService.api_v1_vgdhf_update(payload)
    return response.data
  }
)
export const api_v1_vgdhf_partial_update = createAsyncThunk(
  "vgdhfs/api_v1_vgdhf_partial_update",
  async payload => {
    const response = await apiService.api_v1_vgdhf_partial_update(payload)
    return response.data
  }
)
export const api_v1_vgdhf_destroy = createAsyncThunk(
  "vgdhfs/api_v1_vgdhf_destroy",
  async payload => {
...
const vgdhfsSlice = createSlice({
  ...
  extraReducers: builder => {
    builder
      .addCase(api_v1_vgdhf_list.pending, (state, action) => {
